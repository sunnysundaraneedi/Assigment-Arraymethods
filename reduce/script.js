...
let averageRatings = superMarket.reduce((previousValue, currentValue) => {
  return previousValue + currentValue.rating / superMarket.length;
}, 0);
averageRatings = Math.ceil(averageRatings);

let averageHeight = superMarket.reduce((previousValue, currentValue) => {
  return previousValue + currentValue.height / superMarket.length;
}, 0);
averageHeight = Math.ceil(averageHeight);

let averageWidth = superMarket.reduce((previousValue, currentValue) => {
  return previousValue + currentValue.width / superMarket.length;
}, 0);
averageWidth = Math.ceil(averageWidth);

let averagePrice = superMarket.reduce((previousValue, currentValue) => {
  return previousValue + currentValue.price / superMarket.length;
}, 0);
averagePrice = Math.ceil(averagePrice);

document.write(`The averageRatings of all the elements : ${averageRatings}<br><hr>
                The averageHeight of all the elements : ${averageHeight}<br><hr>
                The averageWidth of all the elements : ${averageWidth}<br><hr>
                The averagePrice of all the elements : ${averagePrice}<br><hr>`);
