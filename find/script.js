...
let result1 = superMarket.find((item) => {
  return item.rating >= 3;
});

let result2 = superMarket.find((item) => {
  return item.type === "vegetable";
});
let result3 = superMarket.find((item) => {
  return item.price < 15;
});

let result4 = superMarket.find((item) => {
  return item.title.includes("Lemon");
});

let result5 = superMarket.find((item) => {
  return item.width === 450 && item.height === 450;
});

document.write(`Element with rating >= 3 : ${result1.title}<br><hr>
                Element with type 'vegetable' : ${result2.title}<br><hr>
                Element with price < 15 : ${result3.title}<br><hr>
                Element with title which contains the word 'Lemon' : ${result4.title}<br><hr>
                Element with height = 450 and width = 450:${result5.title}
`);
