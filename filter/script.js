...
result1 = result1.map((result) => result.title);

let result2 = superMarket.filter((item) => {
  return item.type === "dairy";
});
result2 = result2.map((result) => result.title);
...
let result4 = superMarket.filter((item) => {
  return item.title.includes("with");
});
result4 = result4.map((result) => result.title);

let result5 = superMarket.filter((item) => {
  return item.description.includes("with");
});
result5 = result5.map((result) => result.title);

let result6 = superMarket.filter((item) => {
  return item.width === 400 && item.height === 600;
});
result6 = result6.map((result) => result.title);

document.write(`Elements with rating  < 2 : ${result1}<br><hr>
                Elements with type 'dairy' : ${result2}<br><hr>
                Elements with price  >20 : ${result3}<br><hr>
                Elements with title which contains the word 'with' : ${result4}<br><hr>
                Elements with description which contains the word 'with' : ${result5}<br><hr>
                Element with height = 600 and width = 400 : ${result6}`);
